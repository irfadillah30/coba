...
<body>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq' data-text='㋡'>
       ...
       <p id="pesan4">Aku mau ngomong sesuatu nih, </p>
       <p id="pesan5" class="gaya2">Makasih ya udah hadir dihidup aku, hehe</p>
       <p id="pesan6" class="gaya2">Moga panjang umur, rezeki lancar terus aamiin, biar bisa sering traktirin aku wkwk 😆❤️</p>
       <p id="pesan7" class="gaya2">Canda ya yang traktiran, tapi beneran gak papa ding HAHAHAA!</p>

       <p id="pesan8" class="gaya2">Tapi aku sayang loh sama kamu :v</p>
       <p id="pesan9" class="gaya2">Sampai bertemu dititik terbaik menurut takdir ya.. 🥳❤️</p>
       <p id="pesan10" class="gaya2">Happy Nice Dream!! 🥳</p>
...
<script>
  ...
  var tomnegatif = 'Engga';
    ...
    async function menuju(){pesanwhatsapp = "Makasii udah sayang sama " + nama + " ya luvvvv ><";await swals.fire('OK!', 'Kirim jawabannya ke WhatsApp aku, ya!', 'success');window.location = "https://api.whatsapp.com/send?phone=&text=" + pesanwhatsapp;}
</script>
